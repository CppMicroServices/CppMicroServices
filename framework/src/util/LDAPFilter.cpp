...
namespace cppmicroservices
{
    ...
    bool
    LDAPFilter::IsComplicated() const
    {
        if (d)
        {
    ...
    bool
    LDAPFilter::AddToSimpleCache(StringList const& keywords, LocalCache& cache) const
    {
        if (d)
        {
    ...
    bool
    LDAPFilter::GetMatchedObjectClasses(ObjectClassSet& matchedObjectClasses) const
    {
        if (d)
        {
