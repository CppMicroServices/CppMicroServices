 ...
 * <li>Get the list of bundles loaded in the framework.
 * <li>Get the {@link Bundle} object for a bundle.
 * </ul>
 *
 * <p>
 * A <code>BundleContext</code> object will be created and provided to the
 * bundle associated with this context when it is loaded using the
 ...
 * is loaded. If the <code>BundleContext</code>
