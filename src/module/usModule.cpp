...
std::vector<ServiceReference> Module::GetRegisteredServices() const
{
  std::list<ServiceRegistration> sr;
  std::vector<ServiceReference> res;
  d->coreCtx->services.GetRegisteredByModule(d, sr);
  for (std::list<ServiceRegistration>::const_iterator i = sr.begin();
       i != sr.end(); ++i)
  {
...
std::vector<ServiceReference> Module::GetServicesInUse() const
{
  std::list<ServiceRegistration> sr;
  std::vector<ServiceReference> res;
