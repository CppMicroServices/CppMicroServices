...
by the `s` command. Now we can load our dictionary service bundle by typing
...
time we load and stop our dictionary service bundle, we should see the details
...
by the operating system loader. Stopping it will only succeed if there are
