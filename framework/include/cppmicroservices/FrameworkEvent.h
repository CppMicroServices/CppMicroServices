...
namespace cppmicroservices
{
    ...
    */
     ...
     */
    US_Framework_EXPORT std::ostream& operator<<(std::ostream& os, FrameworkEvent const& evt);
     ...
     */
    US_Framework_EXPORT bool operator==(FrameworkEvent const& rhs, FrameworkEvent const& lhs);
} // namespace cppmicroservices
