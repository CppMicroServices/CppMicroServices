...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const cppmsboost::posix_time::ptime& t) {
    std::tm timetm = cppmsboost::gregorian::to_tm(t.date());
    cppmsboost::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const cppmsboost::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    cppmsboost::gregorian::date d = cppmsboost::gregorian::date_from_tm(timetm);
  ...
  {
    return cppmsboost::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace cppmsboost::posix_time
