...
#ifndef CPPMICROSERVICES_BUNDLEUNINSTALLEDSTATE_HPP
#define CPPMICROSERVICES_BUNDLEUNINSTALLEDSTATE_HPP
...
namespace cppmicroservices
{
    ...
    class BundleUninstalledState final : public BundleLifecycleState
    {
      public:
...
#endif // CPPMICROSERVICES_BUNDLEUNINSTALLEDSTATE_HPP
