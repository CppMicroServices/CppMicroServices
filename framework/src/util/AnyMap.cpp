...
namespace cppmicroservices
{
    ...
    any_map::const_iter::const_iter(any_map::const_iter const& it) : it { nullptr }, iterator_base(it.type)
    {
        switch (type)
        {
            case ORDERED:
    ...
    any_map::const_iter::const_iter(any_map::iterator const& it) : it { nullptr }, iterator_base(it.type)
    {
        switch (type)
        {
            case ORDERED:
    ...
    any_map::iter::iter(iter const& it) : it { nullptr }, iterator_base(it.type)
    {
        switch (type)
        {
            case ORDERED:
