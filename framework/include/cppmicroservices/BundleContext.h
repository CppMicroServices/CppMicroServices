...
#    endif
        ...
        ServiceRegistration<I1, Interfaces...>
        RegisterService(std::shared_ptr<Impl> const& impl, ServiceProperties const& properties = ServiceProperties())
        {
        ...
        ServiceRegistration<I1, Interfaces...>
        RegisterService(std::shared_ptr<ServiceFactory> const& factory,
         ...
         */
        std::vector<ServiceReferenceU> GetServiceReferences(std::string const& clazz,
        ...
        GetServiceReferences(std::string const& filter = std::string())
        {
        ...
        template <class S>
        std::shared_ptr<S>
        GetService(ServiceReference<S> const& reference)
        {
            ServiceReferenceBase const& baseRef = reference;
        ...
        template <class S>
        ServiceObjects<S>
        GetServiceObjects(ServiceReference<S> const& reference)
        {
            if (!d)
            {
         ...
         */
        US_DEPRECATED void RemoveServiceListener(ServiceListener const& listener);
         ...
         * @see BundleListener
         */
        US_DEPRECATED void RemoveBundleListener(BundleListener const& listener);
         ...
         * @see FrameworkListener
         */
        US_DEPRECATED void RemoveFrameworkListener(FrameworkListener const& listener);
         ...
         *    to :any:`AddServiceListener(const ServiceListener&) <cppmicroservices::BundleContext::AddServiceListener>`
         * instead. \endrststar
         *
        ...
        AddServiceListener(R* receiver,
                           void (R::*callback)(ServiceEvent const&),
                           std::string const& filter = std::string())
        {
        ...
        template <class R>
        US_DEPRECATED void
        RemoveServiceListener(R* receiver, void (R::*callback)(ServiceEvent const&))
        {
            RemoveServiceListener(ServiceListenerMemberFunctor(receiver, callback), static_cast<void*>(receiver));
        }
         ...
         *    :any:`AddBundleListener(const BundleListener&) <cppmicroservices::BundleContext::AddBundleListener>`
         instead.
         * \endrststar
         *
         * @tparam R The type of the receiver (containing the member function to be called)
        ...
        template <class R>
        US_DEPRECATED ListenerToken
        AddBundleListener(R* receiver, void (R::*callback)(BundleEvent const&))
        {
            return AddBundleListener(BundleListenerMemberFunctor(receiver, callback), static_cast<void*>(receiver));
        }
        ...
        template <class R>
        US_DEPRECATED void
        RemoveBundleListener(R* receiver, void (R::*callback)(BundleEvent const&))
        {
            RemoveBundleListener(BundleListenerMemberFunctor(receiver, callback), static_cast<void*>(receiver));
        }
         ...
         *    and will be removed in the next major release.
         *    Use `std::bind` to bind the member function and then pass the result to
         *    :any:`AddFrameworkListener(const FrameworkListener&)
         * <cppmicroservices::BundleContext::AddFrameworkListener>` instead. \endrststar
         *
         * @tparam R The type of the receiver (containing the member function to be called)
         * @param receiver The object to connect to.
         * @param callback The member function pointer to call.
        ...
        template <class R>
        US_DEPRECATED ListenerToken
        AddFrameworkListener(R* receiver, void (R::*callback)(FrameworkEvent const&))
        {
        ...
        template <class R>
        US_DEPRECATED void
        RemoveFrameworkListener(R* receiver, void (R::*callback)(FrameworkEvent const&))
        {
         ...
         */
        std::vector<Bundle> InstallBundles(std::string const& location,
      ...
      private:
        ...
        ListenerToken AddBundleListener(BundleListener const& delegate, void* data);
        void RemoveBundleListener(BundleListener const& delegate, void* data);
