...
public:
    ...
    template <class Rep, class Period>
        bool try_lock_for(const cppmsboost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
        try_lock_until(
                      const cppmsboost::chrono::time_point<Clock, Duration>& abs_time);
    void unlock();
    ...
    template <class Rep, class Period>
        bool
        try_lock_shared_for(const cppmsboost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
public:
    ...
    template <class Rep, class Period>
        ...
        try_lock_upgrade_for(
                            const cppmsboost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
namespace cppmsboost {
  namespace thread_v2 {
    ...
    class shared_mutex
    {
      typedef cppmsboost::mutex              mutex_t;
      typedef cppmsboost::condition_variable cond_t;
...
#ifdef BOOST_THREAD_USES_CHRONO
      template <class Rep, class Period>
      bool try_lock_shared_for(const cppmsboost::chrono::duration<Rep, Period>& rel_time)
      {
    ...
    inline shared_mutex::~shared_mutex()
    {
      cppmsboost::lock_guard<mutex_t> _(mut_);
    }
    ...
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, cppmsboost::bind(&shared_mutex::no_writer, cppmsboost::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, cppmsboost::bind(&shared_mutex::no_readers, cppmsboost::ref(*this)));
    }
    ...
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, cppmsboost::bind(
            &shared_mutex::no_writer, cppmsboost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, cppmsboost::bind(
            &shared_mutex::no_readers, cppmsboost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.timed_wait(lk, abs_or_rel_time, cppmsboost::bind(
            &shared_mutex::no_writer, cppmsboost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.timed_wait(lk, abs_or_rel_time, cppmsboost::bind(
            &shared_mutex::no_readers, cppmsboost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
    ...
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, cppmsboost::bind(&shared_mutex::no_writer_no_max_readers, cppmsboost::ref(*this)));
        ...
        const cppmsboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, cppmsboost::bind(
            &shared_mutex::no_writer_no_max_readers, cppmsboost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
...
namespace cppmsboost {
  namespace thread_v2 {
    ...
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, cppmsboost::bind(&upgrade_mutex::no_writer_no_upgrader, cppmsboost::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, cppmsboost::bind(&upgrade_mutex::no_readers, cppmsboost::ref(*this)));
    }
        ...
        const cppmsboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, cppmsboost::bind(
            &upgrade_mutex::no_writer_no_upgrader, cppmsboost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, cppmsboost::bind(
            &upgrade_mutex::no_readers, cppmsboost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, cppmsboost::bind(&upgrade_mutex::no_writer_no_max_readers, cppmsboost::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
      state_ |= num_readers;
    }
        ...
        const cppmsboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, cppmsboost::bind(
            &upgrade_mutex::no_writer_no_max_readers, cppmsboost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
    ...
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, cppmsboost::bind(&upgrade_mutex::no_writer_no_upgrader_no_max_readers, cppmsboost::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
        ...
        const cppmsboost::chrono::time_point<Clock, Duration>& abs_time)
    {
      cppmsboost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, cppmsboost::bind(
            &upgrade_mutex::no_writer_no_upgrader_no_max_readers, cppmsboost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
