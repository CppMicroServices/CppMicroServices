...
// generic replace  -----------------------------------------------------------------//
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            iterator_range<BOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> lit_input(::cppmsboost::as_literal(Input));

            return detail::find_format_copy_impl(
                Output,
                lit_input,
                Formatter,
                Finder( ::cppmsboost::begin(lit_input), ::cppmsboost::end(lit_input) ) );
        }
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            return detail::find_format_copy_impl(
                Input,
                Formatter,
                Finder(::cppmsboost::begin(Input), ::cppmsboost::end(Input)));
        }
