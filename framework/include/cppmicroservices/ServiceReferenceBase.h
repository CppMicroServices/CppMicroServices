...
namespace cppmicroservices
{
     ...
     */
    US_Framework_EXPORT std::ostream& operator<<(std::ostream& os, ServiceReferenceBase const& serviceRef);
} // namespace cppmicroservices
 ...
 * \ingroup gr_servicereference
 *
 * \struct std::hash<cppmicroservices::ServiceReferenceBase> ServiceReferenceBase.h
