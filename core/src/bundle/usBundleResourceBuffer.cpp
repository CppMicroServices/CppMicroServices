...
std::streambuf::pos_type BundleResourceBuffer::seekoff(std::streambuf::off_type off,
...
std::streambuf::pos_type BundleResourceBuffer::seekpos(std::streambuf::pos_type sp,
                                                       std::ios_base::openmode /*which*/)
{
