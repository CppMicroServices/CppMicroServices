...
#ifndef USBUNDLERESOURCESTREAM_H
#define USBUNDLERESOURCESTREAM_H

#include "usBundleResourceBuffer_p.h"
 ...
 */
class US_Core_EXPORT BundleResourceStream : private BundleResourceBuffer, public std::istream
{
...
#endif // USBUNDLERESOURCESTREAM_H
