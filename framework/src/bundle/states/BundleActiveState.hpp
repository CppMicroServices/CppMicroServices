...
#ifndef CPPMICROSERVICES_BUNDLEACTIVESTATE_HPP
#define CPPMICROSERVICES_BUNDLEACTIVESTATE_HPP
...
namespace cppmicroservices
{
    ...
    class BundleActiveState final : public BundleLifecycleState
    {
      public:
        BundleActiveState();
...
#endif // CPPMICROSERVICES_BUNDLEACTIVESTATE_HPP
