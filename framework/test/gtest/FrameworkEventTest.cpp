...
TEST(FrameworkEventTest, testFrameworkEvents)
{
  ...
  ASSERT_EQ(FrameworkEvent::Type::FRAMEWORK_STARTED,
            static_cast<FrameworkEvent::Type>(1));
  ASSERT_EQ(FrameworkEvent::Type::FRAMEWORK_ERROR,
            static_cast<FrameworkEvent::Type>(2));
  ASSERT_EQ(FrameworkEvent::Type::FRAMEWORK_INFO,
            static_cast<FrameworkEvent::Type>(32));
  ASSERT_EQ(FrameworkEvent::Type::FRAMEWORK_WARNING,
            static_cast<FrameworkEvent::Type>(16));
  ASSERT_EQ(FrameworkEvent::Type::FRAMEWORK_STOPPED,
            static_cast<FrameworkEvent::Type>(64));
  ASSERT_EQ(FrameworkEvent::Type::FRAMEWORK_STOPPED_UPDATE,
            static_cast<FrameworkEvent::Type>(128));
  ASSERT_EQ(FrameworkEvent::Type::FRAMEWORK_WAIT_TIMEDOUT,
  ...
  ASSERT_EQ(GetMessageFromStdExceptionPtr(invalid_event.GetThrowable()),
  ...
  ASSERT_EQ(GetMessageFromStdExceptionPtr(error_event.GetThrowable()),
  ...
  try {
    ...
    ASSERT_EQ(std::string(typeid(std::runtime_error).name()),
              typeid(ex).name());
  }
  ...
  ASSERT_EQ(GetMessageFromStdExceptionPtr(info_event.GetThrowable()),
            default_exception_message);
  ...
  ASSERT_EQ(GetMessageFromStdExceptionPtr(warn_event.GetThrowable()),
            default_exception_message);
  ...
  ASSERT_EQ(GetMessageFromStdExceptionPtr(unknown_event.GetThrowable()),
            default_exception_message);
