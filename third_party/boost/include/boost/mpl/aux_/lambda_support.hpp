...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::cppmsboost::mpl::aux::yes_tag operator|( \
      ::cppmsboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::cppmsboost::mpl::aux::no_tag operator|( \
      ::cppmsboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::cppmsboost::mpl::na) >* \
    ); \
/**/
...
::cppmsboost::mpl::aux::yes_tag operator|( \
      ::cppmsboost::mpl::aux::has_rebind_tag<int> \
    , ::cppmsboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
