...
if (NOT EXISTS ${LIBCLANG_INCDIR})
    if (NOT LIBCLANG_LLVM_CONFIG_EXECUTABLE)
        message(FATAL_ERROR "Could NOT find llvm-config executable and LIBCLANG_INCDIR is not set ")
    endif ()
    execute_process(COMMAND ${LIBCLANG_LLVM_CONFIG_EXECUTABLE} --includedir OUTPUT_VARIABLE LIBCLANG_INCDIR OUTPUT_STRIP_TRAILING_WHITESPACE)
    if (NOT EXISTS ${LIBCLANG_INCDIR})
        message(FATAL_ERROR "Could NOT find clang libdir. You can fix this by setting LIBCLANG_INCDIR in your shell or as a cmake variable.")
    endif ()
    set(LIBCLANG_INCDIR ${LIBCLANG_INCDIR} CACHE STRING "Path to the clang library.")
endif ()
