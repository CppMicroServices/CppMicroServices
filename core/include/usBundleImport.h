...
#define US_INITIALIZE_STATIC_BUNDLE(_bundle_name)                          \
  extern "C" US_PREPEND_NAMESPACE(BundleContext)* _us_get_bundle_context_instance_ ## _bundle_name (); \
  extern "C" US_PREPEND_NAMESPACE(BundleContext)* _us_set_bundle_context_instance_ ## _bundle_name (); \
...
#define US_IMPORT_BUNDLE(_bundle_name)                                     \
  ...
  extern "C" US_PREPEND_NAMESPACE(BundleActivator)* _us_bundle_activator_instance_ ## _bundle_name (); \
