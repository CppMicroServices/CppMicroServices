...
ServletContainerPrivate::ServletContainerPrivate(BundleContext bundleCtx, ServletContainer *q)
  : m_Context(std::move(bundleCtx)), m_Server(nullptr), m_ServletTracker(m_Context, this), q(q)
{
}
...
void ServletContainerPrivate::ModifiedService(const ServiceReference<HttpServlet> & /*reference*/,
                                              const std::shared_ptr<ServletHandler> & /*service*/)
{
  // no-op
}

void ServletContainerPrivate::RemovedService(const ServiceReference<HttpServlet> & /*reference*/,
