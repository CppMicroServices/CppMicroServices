...
namespace cppmicroservices
{
    namespace cfrimpl
    {
	    ...
	    std::shared_ptr<cppmicroservices::logservice::Logger> getLogger(const std::string& name) const; 
	    std::shared_ptr<cppmicroservices::logservice::Logger> getLogger(cppmicroservices::Bundle bundle, const std::string& name) const;
