...
void testBinaryResource(Bundle* bundle)
{
  ...
  std::ifstream png(US_CORE_SOURCE_DIR "/test/bundles/libRWithResources/resources/icons/cppmicroservices.png",
...
void testCompressedResource(Bundle* bundle)
{
  ...
  std::ifstream bmp(US_CORE_SOURCE_DIR "/test/bundles/libRWithResources/resources/icons/compressable.bmp",
                    std::ifstream::in | std::ifstream::binary);
...
void testResourceOperators(Bundle* bundle)
{
  ...
  US_UNORDERED_SET_TYPE<BundleResource> resources2;
...
int usBundleResourceTest(int /*argc*/, char* /*argv*/[])
{
