...
macro(_us_create_test_module_helper)
  ...
  if(_res_files)
    usFunctionEmbedResources(_srcs MODULE_NAME ${name} ROOT_DIR ${_res_root} FILES ${_res_files})
  endif()

  add_library(${name} ${_srcs})
  set_property(TARGET ${name} APPEND PROPERTY COMPILE_DEFINITIONS US_MODULE_NAME=${name})
...
function(usFunctionCreateTestModule name)
  set(_srcs ${ARGN})
  set(_res_files )
  usFunctionGenerateModuleInit(_srcs MODULE_NAME ${name})
