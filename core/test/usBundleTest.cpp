...
// Check that the executable's activator was called
...
void frame010a(Framework* framework, BundleContext* mc)
{
  ...
  US_TEST_CONDITION(m->IsStarted(), "Test for loaded flag")
...
{
  Bundle* bundleA = mc->GetBundle("TestBundleA");
  US_TEST_CONDITION_REQUIRED(bundleA != 0, "Test for non-null bundle")
