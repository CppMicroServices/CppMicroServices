 ...
 * will be handled: \c EVENT_TOPIC and \c EVENT_FILTER. Upon an event being published which matches the filter criteria, the
 * HandleEvent() function will be invoked.
 */
class EventHandler
{
public:
