...
struct MyFactory1 : public us::ServiceFactory
{
  ...
  virtual us::InterfaceMapConstPtr GetService(const us::Bundle& bundle, const us::ServiceRegistrationBase& /*registration*/)
  {
  ...
  virtual void UngetService(const us::Bundle& bundle, const us::ServiceRegistrationBase& /*registration*/,
