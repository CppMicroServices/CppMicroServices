...
#ifndef USBUNDLEACTIVATOR_H_
#define USBUNDLEACTIVATOR_H_
...
struct BundleActivator
{
  ...
  /**
   * Called when this bundle is loaded. This method
   ...
   *
   * @param context The execution context of the bundle being loaded.
...
#define US_EXPORT_BUNDLE_ACTIVATOR(_activator_type)                                       \
  extern "C" US_ABI_EXPORT US_PREPEND_NAMESPACE(BundleActivator)* US_CONCAT(_us_bundle_activator_instance_, US_BUNDLE_NAME) () \
  {                                                                                       \
    struct ScopedPointer                                                                  \
    {                                                                                     \
      ScopedPointer(US_PREPEND_NAMESPACE(BundleActivator)* activator = 0) : m_Activator(activator) {} \
      ~ScopedPointer() { delete m_Activator; }                                            \
      US_PREPEND_NAMESPACE(BundleActivator)* m_Activator;                                 \
    };                                                                                    \
                                                                                          \
