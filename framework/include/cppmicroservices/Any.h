...
namespace cppmicroservices
{
    ...
    */
    ...
    std::ostream&
    any_value_to_string(std::ostream& os, std::function<R(Args...)> const&)
    {
        return os;
    }
    ...
    template <typename R, typename... Args>
    std::ostream&
    any_value_to_json(std::ostream& os, std::function<R(Args...)> const&, uint8_t const, int32_t const)
    {
        return os;
    }
    ...
    template <typename R, typename... Args>
    std::ostream&
    any_value_to_cpp(std::ostream& os, std::function<R(Args...)> const&, uint8_t const, int32_t const)
    {
        return os;
    }
