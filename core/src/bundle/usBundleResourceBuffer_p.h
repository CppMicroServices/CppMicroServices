...
#ifndef USBUNDLERESOURCEBUFFER_P_H
#define USBUNDLERESOURCEBUFFER_P_H
...
class US_Core_EXPORT BundleResourceBuffer: public std::streambuf
{
...
private:
  ...
  BundleResourceBuffer(const BundleResourceBuffer&);
  BundleResourceBuffer& operator=(const BundleResourceBuffer&);
...
#endif // USBUNDLERESOURCEBUFFER_P_H
