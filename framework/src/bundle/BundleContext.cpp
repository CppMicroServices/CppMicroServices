...
namespace cppmicroservices
{
    ...
    struct ServiceHolder
    {
        ...
        ~ServiceHolder()
        {
            try
            {
                std::atomic_load(&sref.d)->UngetService(b.lock(), true);
            }
            catch (...)
            {
    ...
    BundleContext::GetService(ServiceReferenceBase const& reference)
    {
        ...
        std::shared_ptr<ServiceHolder<void>> h(
            new ServiceHolder<void>(b, reference, std::atomic_load(&reference.d)->GetService(b.get())));
    ...
    BundleContext::GetService(ServiceReferenceU const& reference)
    {
        ...
        auto serviceInterfaceMap = std::atomic_load(&reference.d)->GetServiceInterfaceMap(b.get());
