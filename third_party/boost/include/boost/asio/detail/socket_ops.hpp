...
BOOST_ASIO_DECL int shutdown(socket_type s,
    int what, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL bool sockatmark(socket_type s, cppmsboost::system::error_code& ec);

BOOST_ASIO_DECL size_t available(socket_type s, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL signed_size_type recv(socket_type s, buf* bufs,
    size_t count, int flags, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL size_t sync_send(socket_type s, state_type state,
    ...
    bool all_empty, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL int getsockopt(socket_type s, state_type state,
    ...
    size_t* optlen, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL int ioctl(socket_type s, state_type& state,
    int cmd, ioctl_arg_type* arg, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL int poll_read(socket_type s,
    state_type state, int msec, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL const char* inet_ntop(int af, const void* src, char* dest,
    size_t length, unsigned long scope_id, cppmsboost::system::error_code& ec);
...
BOOST_ASIO_DECL int gethostname(char* name,
    int namelen, cppmsboost::system::error_code& ec);

#if !defined(BOOST_ASIO_WINDOWS_RUNTIME)

BOOST_ASIO_DECL cppmsboost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, cppmsboost::system::error_code& ec);

BOOST_ASIO_DECL cppmsboost::system::error_code background_getaddrinfo(
...
BOOST_ASIO_DECL cppmsboost::system::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, cppmsboost::system::error_code& ec);

BOOST_ASIO_DECL cppmsboost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, cppmsboost::system::error_code& ec);

BOOST_ASIO_DECL cppmsboost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, cppmsboost::system::error_code& ec);
