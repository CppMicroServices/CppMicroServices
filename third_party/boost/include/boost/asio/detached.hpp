 ...
 * @c cppmsboost::asio::detached. For example:

 * @code my_socket.async_send(my_buffer, cppmsboost::asio::detached);
 * @endcode
 */
class detached_t
{
...
/**
 * See the documentation for cppmsboost::asio::detached_t for a usage example.
 */
