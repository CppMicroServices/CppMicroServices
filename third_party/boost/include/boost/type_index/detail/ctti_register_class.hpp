...
/// \brief Contains BOOST_TYPE_INDEX_REGISTER_CLASS macro implementation that uses cppmsboost::typeindex::ctti_type_index.
...
#define BOOST_TYPE_INDEX_REGISTER_CLASS                                                                             \
    virtual const cppmsboost::typeindex::detail::ctti_data& boost_type_index_type_id_runtime_() const BOOST_NOEXCEPT {   \
        return cppmsboost::typeindex::detail::ctti_construct_typeid_ref(this);                                           \
    }                                                                                                               \
/**/
/// @endcond
