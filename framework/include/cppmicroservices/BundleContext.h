...
public:
   ...
   */
  void RemoveServiceListener(const ServiceListener& callable);
   ...
   * @see BundleListener
   */
  void RemoveBundleListener(const BundleListener& callable);
   ...
   * @see FrameworkListener
   */
  void RemoveFrameworkListener(const FrameworkListener& callable);
