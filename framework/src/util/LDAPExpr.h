...
namespace cppmicroservices
{
    ...
    class LDAPExpr
    {
      ...
      private:
        ...
        //!
        static bool CompareString(const absl::string_view s1, int op, const absl::string_view s2);
        ...
        //!
        static bool PatSubstr(const absl::string_view s, int si, const absl::string_view pat, int pi);
