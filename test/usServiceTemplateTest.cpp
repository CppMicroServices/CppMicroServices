...
int usServiceTemplateTest(int /*argc*/, char* /*argv*/[])
{
  ...
  i1 = mc->GetService(sr2.GetReference(InterfaceT<Interface1>()));
  US_TEST_CONDITION(i1 == static_cast<Interface1*>(&s2), "interface1 ptr")
  i1 = NULL;
  US_TEST_CONDITION(mc->UngetService(sr2.GetReference(InterfaceT<Interface1>())), "unget interface1 ptr")
  i1 = mc->GetService(sfr2.GetReference(InterfaceT<Interface1>()));
  US_TEST_CONDITION(i1 == static_cast<Interface1*>(f2.m_idToServiceMap[mc->GetModule()->GetModuleId()]), "interface1 factory ptr")
  i1 = NULL;
  US_TEST_CONDITION(mc->UngetService(sfr2.GetReference(InterfaceT<Interface1>())), "unget interface1 factory ptr")
  Interface2* i2 = mc->GetService(sr2.GetReference(InterfaceT<Interface2>()));
  US_TEST_CONDITION(i2 == static_cast<Interface2*>(&s2), "interface2 ptr")
  i2 = NULL;
  US_TEST_CONDITION(mc->UngetService(sr2.GetReference(InterfaceT<Interface2>())), "unget interface2 ptr")
  i2 = mc->GetService(sfr2.GetReference(InterfaceT<Interface2>()));
  US_TEST_CONDITION(i2 == static_cast<Interface2*>(f2.m_idToServiceMap[mc->GetModule()->GetModuleId()]), "interface2 factory ptr")
  i2 = NULL;
  US_TEST_CONDITION(mc->UngetService(sfr2.GetReference(InterfaceT<Interface2>())), "unget interface2 factory ptr")

  i1 = mc->GetService(sr3.GetReference(InterfaceT<Interface1>()));
  US_TEST_CONDITION(i1 == static_cast<Interface1*>(&s3), "interface1 ptr")
  i1 = NULL;
  US_TEST_CONDITION(mc->UngetService(sr3.GetReference(InterfaceT<Interface1>())), "unget interface1 ptr")
  i1 = mc->GetService(sfr3.GetReference(InterfaceT<Interface1>()));
  US_TEST_CONDITION(i1 == static_cast<Interface1*>(f3.m_idToServiceMap[mc->GetModule()->GetModuleId()]), "interface1 factory ptr")
  i1 = NULL;
  US_TEST_CONDITION(mc->UngetService(sfr3.GetReference(InterfaceT<Interface1>())), "unget interface1 factory ptr")
  i2 = mc->GetService(sr3.GetReference(InterfaceT<Interface2>()));
  US_TEST_CONDITION(i2 == static_cast<Interface2*>(&s3), "interface2 ptr")
  i2 = NULL;
  US_TEST_CONDITION(mc->UngetService(sr3.GetReference(InterfaceT<Interface2>())), "unget interface2 ptr")
  i2 = mc->GetService(sfr3.GetReference(InterfaceT<Interface2>()));
  US_TEST_CONDITION(i2 == static_cast<Interface2*>(f3.m_idToServiceMap[mc->GetModule()->GetModuleId()]), "interface2 factory ptr")
  i2 = NULL;
  US_TEST_CONDITION(mc->UngetService(sfr3.GetReference(InterfaceT<Interface2>())), "unget interface2 factory ptr")
  Interface3* i3 = mc->GetService(sr3.GetReference(InterfaceT<Interface3>()));
  US_TEST_CONDITION(i3 == static_cast<Interface3*>(&s3), "interface3 ptr")
  i3 = NULL;
  US_TEST_CONDITION(mc->UngetService(sr3.GetReference(InterfaceT<Interface3>())), "unget interface3 ptr")
  i3 = mc->GetService(sfr3.GetReference(InterfaceT<Interface3>()));
  US_TEST_CONDITION(i3 == static_cast<Interface3*>(f3.m_idToServiceMap[mc->GetModule()->GetModuleId()]), "interface3 factory ptr")
  i3 = NULL;
  US_TEST_CONDITION(mc->UngetService(sfr3.GetReference(InterfaceT<Interface3>())), "unget interface3 factory ptr")
