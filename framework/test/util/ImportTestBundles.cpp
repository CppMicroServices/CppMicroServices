...
CPPMICROSERVICES_IMPORT_BUNDLE(TestBundleActivatorTransition1)
CPPMICROSERVICES_IMPORT_BUNDLE(TestBundleActivatorTransition2)
CPPMICROSERVICES_IMPORT_BUNDLE(TestBundleActivatorTransition3)
CPPMICROSERVICES_IMPORT_BUNDLE(TestBundleActivatorTransition4)
CPPMICROSERVICES_IMPORT_BUNDLE(TestBundleActivatorTransition5)
CPPMICROSERVICES_IMPORT_BUNDLE(TestBundleActivatorTransition6)
