...
#ifndef USBUNDLEEVENTHOOK_H
#define USBUNDLEEVENTHOOK_H
 ...
 * (starting, started, stopping, and stopped) operations.
 *
 * @remarks Implementations of this interface are required to be thread-safe.
 */
struct US_Core_EXPORT BundleEventHook
{
   ...
   * delivery when a bundle is starting, started, stopping, and stopped.
