...
public:
  ...
  void Start(BundleContext* mc)
  {
    ...
    this->mc = mc;
    factoryService = mc->RegisterService<TestBundleH>(this);
    prototypeFactoryService = mc->RegisterService<TestBundleH,TestBundleH2>(static_cast<ServiceFactory*>(&prototypeFactory));
  }
