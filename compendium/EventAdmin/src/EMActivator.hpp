...
namespace cppmicroservices::emimpl
{
    class EMActivator final : public cppmicroservices::BundleActivator
    {
      public:
        EMActivator() = default;
        EMActivator(EMActivator const&) = delete;
        EMActivator(EMActivator&&) = delete;
        EMActivator& operator=(EMActivator const&) = delete;
      ...
      private:
        ...
        cppmicroservices::ServiceRegistration<cppmicroservices::service::em::EventAdmin> eventAdminReg;
    };
} // namespace cppmicroservices::emimpl
