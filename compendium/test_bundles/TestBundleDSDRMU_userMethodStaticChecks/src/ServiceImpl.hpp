#ifndef SERVICE_IMPL_DSDRMU_USERMETHODSTATICCHECKS_HPP
#define SERVICE_IMPL_DSDRMU_USERMETHODSTATICCHECKS_HPP
...
#endif // SERVICE_IMPL_DSDRMU_USERMETHODSTATICCHECKS_HPP
