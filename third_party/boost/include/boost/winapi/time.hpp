...
BOOST_SYMBOL_IMPORT cppmsboost::winapi::ULONGLONG_ BOOST_WINAPI_WINAPI_CC
...
{
    cppmsboost::winapi::SYSTEMTIME_ st;
    cppmsboost::winapi::GetSystemTime(&st);
    cppmsboost::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
