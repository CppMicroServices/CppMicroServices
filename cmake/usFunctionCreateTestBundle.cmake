...
function(usFunctionCreateTestBundleWithResources name)
  cmake_parse_arguments(US_TEST "SKIP_BUNDLE_LIST;LINK_RESOURCES;APPEND_RESOURCES;USES_DS" "RESOURCES_ROOT;LIBRARY_EXTENSION;BUNDLE_SYMBOLIC_NAME" "SOURCES;RESOURCES;BINARY_RESOURCES;LINK_LIBRARIES;OTHER_LIBRARIES" "" ${ARGN})
  ...
  if(NOT US_TEST_USES_DS)
    usFunctionGenerateBundleInit(TARGET ${name} OUT _srcs)
  else()
    message(WARNING "Skipping bundle init for ${name}")
  endif()
  _us_create_test_bundle_helper()
endfunction()
