#ifndef SERVICE_IMPL_DSTBV3_1_HPP
#define SERVICE_IMPL_DSTBV3_1_HPP
...
namespace sample
{
    class ServiceComponentBV3_1 : public test::Interface2
    {
      public:
        ServiceComponentBV3_1() = default;
...
#endif // SERVICE_IMPL_DSTBV3_1_HPP
