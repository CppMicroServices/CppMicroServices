...
#ifndef USBUNDLEVERSION_H
#define USBUNDLEVERSION_H
 ...
 */
class US_Core_EXPORT BundleVersion {
 ...
 * \ingroup MicroServices
 */
US_Core_EXPORT std::ostream& operator<<(std::ostream& os, const US_PREPEND_NAMESPACE(BundleVersion)& v);
