...
namespace detail
{
      ...
      cppmsboost::system::error_code& ec)
  {
    ...
    cppmsboost::asio::detail::consuming_buffers<mutable_buffer,
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  cppmsboost::asio::detail::throw_error(ec, "read_at");
...
namespace detail
{
  ...
  //private:
    typedef cppmsboost::asio::detail::consuming_buffers<mutable_buffer,
