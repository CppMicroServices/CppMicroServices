#ifndef SERVICE_IMPL_DSCA20_5_HPP
#define SERVICE_IMPL_DSCA20_5_HPP
...
namespace sample
{
    ...
    {
      public:
        ServiceComponentCA20_5(std::shared_ptr<test::DSGraph01> ) : active(false) {}
...
#endif // SERVICE_IMPL_DSCA20_5_HPP
