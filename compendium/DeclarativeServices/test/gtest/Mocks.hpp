...
#    pragma warning(pop)
        ...
        class MockComponentManager : public ComponentManager
        {
          public:
            ...
            MOCK_METHOD2(WaitForFuture, void(std::shared_future<void>&, std::shared_ptr<AsyncExecWrapper>));
            MOCK_METHOD0(Initialize, void(void));
            MOCK_CONST_METHOD0(IsEnabled, bool(void));
            MOCK_METHOD1(Enable, std::shared_future<void>(std::shared_ptr<AsyncExecWrapper>));
            MOCK_METHOD1(Disable, std::shared_future<void>(std::shared_ptr<AsyncExecWrapper>));
        ...
        {
          public:
            MOCK_METHOD2(Enable, std::shared_future<void>(ComponentManagerImpl&, std::shared_ptr<AsyncExecWrapper>));
            MOCK_METHOD2(Disable, std::shared_future<void>(ComponentManagerImpl&, std::shared_ptr<AsyncExecWrapper>));
