...
#define US_INITIALIZE_BUNDLE                                                                                                     \
    US_PREPEND_NAMESPACE(BundleContext)* US_CONCAT(_us_bundle_context_instance_, US_BUNDLE_NAME) = 0;                            \
                                                                                                                                 \
    extern "C" US_ABI_EXPORT US_PREPEND_NAMESPACE(BundleContext)* US_CONCAT(_us_get_bundle_context_instance_, US_BUNDLE_NAME) () \
    {                                                                                                                            \
        return US_CONCAT(_us_bundle_context_instance_, US_BUNDLE_NAME);                                                          \
    }                                                                                                                            \
                                                                                                                                 \
    extern "C" US_ABI_EXPORT void US_CONCAT(_us_set_bundle_context_instance_, US_BUNDLE_NAME) (US_PREPEND_NAMESPACE(BundleContext)* ctx) \
    {                                                                                                                                    \
