...
namespace cppmicroservices
{
    ...
    {
      public:
        ResDataContainer(std::unique_ptr<HMODULE, hModuleDeleter> moduleHandle, LPVOID data, DWORD dataSize)
    ...
    {
      public:
        BundlePEFile(std::string location) : m_rawData(nullptr)
        {
