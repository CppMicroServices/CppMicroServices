...
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleCircularBasic)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleCircularDouble)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleCircularOptReq)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleCircularJeffExample)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleCircularSelfDep)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleCircularTwoComp)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleCircularInfLoop)
