...
namespace cppmsboost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(cppmsboost::long_long_type)(cppmsboost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (cppmsboost::long_long_type)(cppmsboost::ulong_long_type)
