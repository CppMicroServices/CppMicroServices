...
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleDSCA20_5)
...
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleDSCA29)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleDSCA30)
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleDSDROM)
...
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleDSDependentNoInjectActivatedRef)
...
CPPMICROSERVICES_INITIALIZE_STATIC_BUNDLE(TestBundleDSUpstreamDependencyC)
