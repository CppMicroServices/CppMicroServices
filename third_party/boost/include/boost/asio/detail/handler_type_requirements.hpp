...
#define BOOST_ASIO_LEGACY_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(cppmsboost::asio::detail::zero_arg_copyable_handler_test( \
          cppmsboost::asio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef cppmsboost::asio::detail::handler_type_requirements< \
      sizeof( \
        cppmsboost::asio::detail::argbyv( \
          cppmsboost::asio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        cppmsboost::asio::detail::lvref< \
          asio_true_handler_type>()(), \
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(cppmsboost::asio::detail::two_arg_handler_test( \
          cppmsboost::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const cppmsboost::system::error_code*>(0), \
  ...
  typedef cppmsboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        cppmsboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            cppmsboost::asio::detail::lvref<const cppmsboost::system::error_code>(), \
            cppmsboost::asio::detail::lvref<const std::size_t>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(cppmsboost::asio::detail::one_arg_handler_test( \
          cppmsboost::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const cppmsboost::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_MOVE_ACCEPT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(cppmsboost::system::error_code, socket_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(cppmsboost::asio::detail::two_arg_move_handler_test( \
          cppmsboost::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const cppmsboost::system::error_code*>(0), \
  ...
  typedef cppmsboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        cppmsboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            cppmsboost::asio::detail::lvref<const cppmsboost::system::error_code>(), \
            cppmsboost::asio::detail::rvref<socket_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RANGE_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(cppmsboost::system::error_code, endpoint_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(cppmsboost::asio::detail::two_arg_handler_test( \
  ...
  typedef cppmsboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        cppmsboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            cppmsboost::asio::detail::lvref<const cppmsboost::system::error_code>(), \
            cppmsboost::asio::detail::lvref<const endpoint_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ITERATOR_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(cppmsboost::system::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(cppmsboost::asio::detail::two_arg_handler_test( \
  ...
  typedef cppmsboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        cppmsboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            cppmsboost::asio::detail::lvref<const cppmsboost::system::error_code>(), \
            cppmsboost::asio::detail::lvref<const iter_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RESOLVE_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(cppmsboost::system::error_code, range_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(cppmsboost::asio::detail::two_arg_handler_test( \
  ...
  typedef cppmsboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        cppmsboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            cppmsboost::asio::detail::lvref<const cppmsboost::system::error_code>(), \
            cppmsboost::asio::detail::lvref<const range_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
  ...
  typedef cppmsboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        cppmsboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            cppmsboost::asio::detail::lvref<const cppmsboost::system::error_code>(), \
            cppmsboost::asio::detail::lvref<const int>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
