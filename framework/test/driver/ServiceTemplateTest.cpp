...
struct MyFactory1 : public cppmicroservices::ServiceFactory
{
  ...
  virtual cppmicroservices::InterfaceMapConstPtr GetService(const cppmicroservices::Bundle& bundle, const cppmicroservices::ServiceRegistrationBase& /*registration*/)
  {
  ...
  virtual void UngetService(const cppmicroservices::Bundle& bundle, const cppmicroservices::ServiceRegistrationBase& /*registration*/,
                            const cppmicroservices::InterfaceMapConstPtr& service)
  {
    ...
    {
      US_TEST_CONDITION((iter->second) == cppmicroservices::ExtractInterface<Interface1>(service), "Compare service pointer")
...
struct MyFactory2 : public cppmicroservices::ServiceFactory
{
                            ...
                            const cppmicroservices::InterfaceMapConstPtr& service)
  {
    ...
    if (iter != m_idToServiceMap.end())
    {
      US_TEST_CONDITION((iter->second) == cppmicroservices::ExtractInterface<Interface2>(service), "Compare service pointer")
      m_idToServiceMap.erase(iter);
    }
  }
};
...
struct MyFactory3 : public cppmicroservices::ServiceFactory
{
                            ...
                            const cppmicroservices::InterfaceMapConstPtr& service)
  {
    ...
    if (iter != m_idToServiceMap.end())
    {
      US_TEST_CONDITION((iter->second) == cppmicroservices::ExtractInterface<Interface3>(service), "Compare service pointer")
      m_idToServiceMap.erase(iter);
    }
  }
};
